...
const translations: Record<string, Record<Language, string>> = {
  ...
  orderStatusBreakdown: { bn: 'অর্ডার স্ট্যাটাস বিশ্লেষণ', en: 'Order Status Breakdown' },
  ...
  // Reports
  reportsDesc: { bn: 'ব্যবসার পরিসংখ্যান দেখুন', en: 'View business statistics' },
  ...
  // Settings
  settingsDesc: { bn: 'দোকানের সেটিংস পরিচালনা করুন', en: 'Manage shop settings' },
  ...
  shopInfoDesc: { bn: 'দোকানের নাম, ঠিকানা ও লোগো সেট করুন', en: 'Set your shop name, address and logo' },
  ...
  dataManagementLockDesc: { bn: 'অ্যাক্সেস করতে পিন দিন', en: 'Enter PIN to access' },
  enterPin: { bn: 'পিন দিন', en: 'Enter PIN' },
  enterPinDesc: { bn: 'ডেটা ম্যানেজমেন্ট সেকশন সুরক্ষিত। অ্যাক্সেস করতে পিন কোড দিন।', en: 'Data management is protected. Enter your PIN to continue.' },
  incorrectPin: { bn: 'ভুল পিন, আবার চেষ্টা করুন', en: 'Incorrect PIN, try again' },
  dataUnlocked: { bn: 'ডেটা ম্যানেজমেন্ট আনলক হয়েছে', en: 'Data management unlocked' },
  ...
  darkModeDesc: { bn: 'ডার্ক থিম চালু/বন্ধ করুন', en: 'Toggle dark theme on/off' },
  colorTheme: { bn: 'কালার থিম', en: 'Color Theme' },
  colorThemeDesc: { bn: 'অ্যাপের প্রাইমারি কালার নির্বাচন করুন', en: 'Choose the primary color for the app' },
  fontSize: { bn: 'ফন্ট সাইজ', en: 'Font Size' },
  fontSizeDesc: { bn: 'অ্যাপের টেক্সটের আকার পরিবর্তন করুন', en: 'Change the text size of the app' },
  ...
  borderRadiusDesc: { bn: 'কার্ড ও বাটনের কোণার আকৃতি', en: 'Shape of card and button corners' },
  ...
  layoutDensityDesc: { bn: 'কন্টেন্টের স্পেসিং নিয়ন্ত্রণ করুন', en: 'Control the spacing of content' },
  densityCompact: { bn: 'কমপ্যাক্ট', en: 'Compact' },
  densityDefault: { bn: 'ডিফল্ট', en: 'Default' },
  densityComfortable: { bn: 'প্রশস্ত', en: 'Comfortable' },
  languageDesc: { bn: 'অ্যাপের ভাষা পরিবর্তন করুন', en: 'Change the display language' },
  reduceMotion: { bn: 'অ্যানিমেশন কমান', en: 'Reduce Motion' },
  reduceMotionDesc: { bn: 'অ্যানিমেশন ও ট্রানজিশন কমিয়ে আনুন', en: 'Minimize animations and transitions' },
  ...
  smsProviderSettings: { bn: 'SMS প্রোভাইডার সেটিংস', en: 'SMS Provider Settings' },
  ...
  loginSubtitle: { bn: 'ম্যানেজমেন্ট সিস্টেমে লগইন করুন', en: 'Login to Management System' },
  ...
  defaultCredentials: { bn: 'ডিফল্ট: admin / admin123', en: 'Default: admin / admin123' },
  email: { bn: 'ইমেইল', en: 'Email' },
  emailPlaceholder: { bn: 'আপনার ইমেইল দিন', en: 'Enter your email' },
  passwordPlaceholder: { bn: 'আপনার পাসওয়ার্ড দিন', en: 'Enter your password' },
  signup: { bn: 'সাইন আপ', en: 'Sign Up' },
  signupSubtitle: { bn: 'নতুন অ্যাকাউন্ট তৈরি করুন', en: 'Create a new account' },
  signupSuccess: { bn: '✅ সাইন আপ সফল! ইমেইল ভেরিফাই করুন।', en: '✅ Signup successful! Please verify your email.' },
  signupError: { bn: 'সাইন আপ ব্যর্থ', en: 'Signup failed' },
  alreadyHaveAccount: { bn: 'আগে থেকে অ্যাকাউন্ট আছে?', en: 'Already have an account?' },
  ...
  resetLinkSentDesc: { bn: 'আপনার ইমেইল চেক করুন', en: 'Check your email inbox' },
  passwordResetSuccess: { bn: '✅ পাসওয়ার্ড রিসেট সফল হয়েছে', en: '✅ Password reset successful' },
  enterEmailForReset: { bn: 'আপনার ইমেইল দিন রিসেট লিংক পেতে', en: 'Enter your email to receive a reset link' },
  backToLogin: { bn: 'লগইনে ফিরুন', en: 'Back to Login' },
  confirmNewPassword: { bn: 'পাসওয়ার্ড নিশ্চিত করুন', en: 'Confirm New Password' },
  ...
  invalidBdMobile: { bn: 'সঠিক বাংলাদেশি মোবাইল নম্বর দিন', en: 'Enter a valid Bangladeshi mobile number' },
  addressPlaceholder: { bn: 'ঠিকানা লিখুন', en: 'Enter address' },
  notesPlaceholder: { bn: 'অতিরিক্ত তথ্য', en: 'Additional info' },
  customerUpdated: { bn: '✅ কাস্টমার আপডেট হয়েছে', en: '✅ Customer updated' },
  customerAdded: { bn: '✅ কাস্টমার যোগ করা হয়েছে', en: '✅ Customer added' },
  customerDeleted: { bn: '🗑️ কাস্টমার মুছে ফেলা হয়েছে', en: '🗑️ Customer deleted' },
  noCustomerFound: { bn: 'কোনো কাস্টমার পাওয়া যায়নি', en: 'No customer found' },
  ...
  productImage: { bn: 'প্রোডাক্ট ছবি (ঐচ্ছিক)', en: 'Product Image (Optional)' },
  ...
  productDeleted: { bn: '🗑️ প্রোডাক্ট মুছে ফেলা হয়েছে', en: '🗑️ Product deleted' },

  // Create Order
  createOrderTitle: { bn: 'নতুন অর্ডার', en: 'New Order' },
  createOrderDesc: { bn: 'অর্ডার তৈরি করতে নিচের ধাপগুলো সম্পন্ন করুন', en: 'Complete the steps below to create an order' },
  ...
  specialNotesPlaceholder: { bn: 'বিশেষ কোনো নির্দেশনা...', en: 'Any special instructions...' },
  ...
  orderCreated: { bn: '✅ অর্ডার সফলভাবে তৈরি হয়েছে', en: '✅ Order created successfully' },
  smsSuccessDesc: { bn: 'নম্বরে SMS পাঠানো হয়েছে', en: 'SMS sent to number' },
  smsFailTitle: { bn: '⚠️ SMS পাঠানো যায়নি', en: '⚠️ SMS failed' },
  smsFailDesc: { bn: 'অর্ডার তৈরি হয়েছে, কিন্তু SMS পাঠানো সম্ভব হয়নি।', en: 'Order created but SMS could not be sent.' },
  unitPriceLabel: { bn: 'ইউনিট প্রাইস (৳)', en: 'Unit Price (৳)' },

  // Orders List
  ordersCount: { bn: 'টি অর্ডার', en: 'orders' },
  searchOrderPlaceholder: { bn: 'নাম, ফোন বা অর্ডার ID...', en: 'Name, phone or order ID...' },
  all: { bn: 'সব', en: 'All' },
  ...
  statusUpdatedFull: { bn: '✅ অর্ডার স্ট্যাটাস আপডেট হয়েছে', en: '✅ Order status updated' },
  editOrder: { bn: 'অর্ডার এডিট করুন', en: 'Edit Order' },
  editOrderDesc: { bn: 'অর্ডারের তথ্য পরিবর্তন করুন', en: 'Modify order details' },
  ...
  deleteOrderDesc: { bn: 'এই অর্ডারটি স্থায়ীভাবে মুছে যাবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।', en: 'This order will be permanently deleted. This action cannot be undone.' },
  ...
  thankYou: { bn: 'ধন্যবাদ আপনার অর্ডারের জন্য!', en: 'Thank you for your order!' },
  ...
  assignedTo: { bn: 'কারিগর', en: 'Assigned To' },
  notAssigned: { bn: 'নির্ধারিত নয়', en: 'Not Assigned' },

  // Categories
  categoriesCount: { bn: 'টি ক্যাটাগরি', en: 'categories' },
  newCategoryPlaceholder: { bn: 'নতুন ক্যাটাগরি নাম...', en: 'New category name...' },
  categoryExists: { bn: 'এই ক্যাটাগরি আগে থেকেই আছে', en: 'This category already exists' },
  ...
  deleteCategoryDesc: { bn: 'ক্যাটাগরি মুছে ফেলা হবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।', en: 'This category will be deleted. This action cannot be undone.' },
  deleteProduct: { bn: 'প্রোডাক্ট মুছে ফেলবেন?', en: 'Delete Product?' },
  deleteProductDesc: { bn: 'এই প্রোডাক্টটি মুছে ফেলা হবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।', en: 'This product will be deleted. This action cannot be undone.' },
  deleteCustomer: { bn: 'কাস্টমার মুছে ফেলবেন?', en: 'Delete Customer?' },
  deleteCustomerDesc: { bn: 'এই কাস্টমারটি মুছে ফেলা হবে। এই কাজটি পূর্বাবস্থায় ফেরানো যাবে না।', en: 'This customer will be deleted. This action cannot be undone.' },
  ...
  invoicePrefixDesc: { bn: 'ইনভয়েস নম্বরের আগে যোগ হবে', en: 'Added before invoice number' },
  defaultAdvanceDesc: { bn: 'ডিফল্ট অ্যাডভান্স পেমেন্ট শতাংশ', en: 'Default advance payment percentage' },
  autoPrintDesc: { bn: 'অর্ডার তৈরি হলে স্বয়ংক্রিয়ভাবে প্রিন্ট ডায়ালগ খুলবে', en: 'Auto open print dialog when order is created' },
  smsNotificationDesc: { bn: 'অর্ডার তৈরি হলে কাস্টমারকে SMS নোটিফিকেশন পাঠান', en: 'Send SMS notification to customer when order is created' },
  smsApiKeyPlaceholder: { bn: 'আপনার BulkSMSBD API Key', en: 'Your BulkSMSBD API Key' },
  smsApiKeyDesc: { bn: 'BulkSMSBD থেকে প্রাপ্ত API Key দিন', en: 'Enter API Key from BulkSMSBD' },
  smsSenderIdPlaceholder: { bn: 'আপনার অনুমোদিত Sender ID', en: 'Your approved Sender ID' },
  smsSenderIdDesc: { bn: 'BulkSMSBD তে অনুমোদিত Sender ID দিন', en: 'Enter approved Sender ID from BulkSMSBD' },
  smsWarning: { bn: 'SMS পাঠাতে BulkSMSBD অ্যাকাউন্ট প্রয়োজন।', en: 'BulkSMSBD account required to send SMS.' },
  ...
  lowBalanceWarning: { bn: 'আপনার SMS ব্যালেন্স থ্রেশহোল্ডের নিচে! দয়া করে রিচার্জ করুন।', en: 'Your SMS balance is below threshold! Please recharge.' },
  lowBalanceThreshold: { bn: 'লো ব্যালেন্স থ্রেশহোল্ড (৳)', en: 'Low Balance Threshold (৳)' },
  thresholdDesc: { bn: 'ব্যালেন্স এই পরিমাণের নিচে গেলে সতর্কতা দেখাবে', en: 'Warning shown when balance drops below this amount' },
  enterApiKey: { bn: 'ব্যালেন্স চেক করতে API Key দিন', en: 'Enter API Key to check balance' },
  
  settingsSaved: { bn: 'সেটিংস সেভ হয়েছে', en: 'Settings saved' },
  settingsSavedDesc: { bn: 'আপনার পরিবর্তনগুলি সংরক্ষিত হয়েছে।', en: 'Your changes have been saved.' },
  apiKeyRequired: { bn: 'API Key প্রয়োজন', en: 'API Key required' },
  apiKeyRequiredDesc: { bn: 'প্রথমে BulkSMSBD API Key দিন', en: 'Enter BulkSMSBD API Key first' },
  balanceLow: { bn: 'SMS ব্যালেন্স কম!', en: 'Low SMS balance!' },
  balanceCheckSuccess: { bn: 'ব্যালেন্স চেক সফল', en: 'Balance check successful' },
  balanceInfoReceived: { bn: 'ব্যালেন্স তথ্য পাওয়া গেছে', en: 'Balance info received' },
  balanceCheckFailed: { bn: 'ব্যালেন্স চেক ব্যর্থ', en: 'Balance check failed' },
  ...
  noNewNotifications: { bn: 'কোনো নতুন নোটিফিকেশন নেই', en: 'No new notifications' },
  ...
  emailUpdateDesc: { bn: 'নতুন ইমেইলে ভেরিফিকেশন লিংক পাঠানো হয়েছে', en: 'Verification link sent to new email' },
  ...
  newPasswordPlaceholder: { bn: 'নতুন পাসওয়ার্ড দিন', en: 'Enter new password' },
  confirmPasswordPlaceholder: { bn: 'পাসওয়ার্ড আবার দিন', en: 'Re-enter password' },
  updatePassword: { bn: 'পাসওয়ার্ড আপডেট', en: 'Update Password' },
  passwordUpdated: { bn: '✅ পাসওয়ার্ড আপডেট হয়েছে', en: '✅ Password updated' },
  passwordUpdateFailed: { bn: 'পাসওয়ার্ড আপডেট ব্যর্থ', en: 'Password update failed' },
  passwordMismatch: { bn: 'পাসওয়ার্ড মিলছে না', en: 'Passwords do not match' },
  passwordTooShort: { bn: 'পাসওয়ার্ড কমপক্ষে ৬ অক্ষর হতে হবে', en: 'Password must be at least 6 characters' },

  // Role Management
  roleManagement: { bn: 'রোল ম্যানেজমেন্ট', en: 'Role Management' },
  roleManagementDesc: { bn: 'কাস্টম রোল তৈরি করুন এবং মেনু পারমিশন সেট করুন', en: 'Create custom roles and set menu permissions' },
  ...
  deleteRoleDesc: { bn: 'আপনি কি নিশ্চিত যে এই রোলটি মুছে ফেলতে চান? এটি পূর্বাবস্থায় ফেরানো যাবে না।', en: 'Are you sure you want to delete this role? This action cannot be undone.' },
  noRoles: { bn: 'কোনো রোল নেই', en: 'No roles yet' },
  noRolesDesc: { bn: 'আপনার প্রথম রোল তৈরি করতে উপরের বাটনে ক্লিক করুন', en: 'Click the button above to create your first role' },
  ...
  roleDialogDesc: { bn: 'রোলের নাম এবং মেনু অ্যাক্সেস পারমিশন সেট করুন', en: 'Set role name and menu access permissions' },
  ...
  staffManagementDesc: { bn: 'স্টাফ যোগ করুন, রোল অ্যাসাইন করুন এবং লগইন ক্রেডেনশিয়াল তৈরি করুন', en: 'Add staff, assign roles and create login credentials' },
  addStaff: { bn: 'স্টাফ যোগ করুন', en: 'Add Staff' },
  editStaff: { bn: 'স্টাফ এডিট', en: 'Edit Staff' },
  deleteStaff: { bn: 'স্টাফ মুছুন', en: 'Delete Staff' },
  deleteStaffDesc: { bn: 'আপনি কি নিশ্চিত যে এই স্টাফকে মুছে ফেলতে চান?', en: 'Are you sure you want to delete this staff member?' },
  ...
  staffDialogDesc: { bn: 'স্টাফের তথ্য এবং রোল সেট করুন', en: 'Set staff details and assign a role' },
  ...
  staffInactiveDesc: { bn: 'স্টাফ লগইন করতে পারবে না', en: 'Staff cannot log in' },
  loginEnabled: { bn: 'লগইন সক্রিয়', en: 'Login enabled' },
  noLogin: { bn: 'লগইন নেই', en: 'No login' },
  createLoginCredentials: { bn: 'লগইন ক্রেডেনশিয়াল তৈরি', en: 'Create Login Credentials' },
  createCredentialsDesc: { bn: 'এই স্টাফের জন্য লগইন ইমেইল ও পাসওয়ার্ড তৈরি করুন:', en: 'Create login email and password for:' },
  ...
  staffAccountCreated: { bn: 'স্টাফ অ্যাকাউন্ট তৈরি হয়েছে', en: 'Staff account created successfully' },
  staffMenu: { bn: 'স্টাফ', en: 'Staff' },
  craftsmanDashboard: { bn: 'কারিগর ড্যাশবোর্ড', en: 'Craftsman Dashboard' },
  craftsmanDashboardDesc: { bn: 'কারিগরদের অ্যাসাইন করা অর্ডার দেখুন', en: 'View orders assigned to craftsmen' },
  noAssignedOrders: { bn: 'কোনো অ্যাসাইন করা অর্ডার নেই', en: 'No assigned orders' },
